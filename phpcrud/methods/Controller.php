...
class controllerStates {
	...
	public function listState($state) {
		$this->state->set('id_state', $state);
		$data = $this->state->get_state();
		return $data;
	}
...
class controllerCounties {
	private $county;

	public function __construct() {
		$this->county = new Countries();
	}
	
	public function listCounty($county) {
		$this->county->set('id_county', $county);
		$data = $this->county->get_county();
		return $data;
	}

	public function listCounties() {
		$data = $this->county->get_counties();
		return $data;
	}
}
...
class controllerSector {
	...
	public function listSector($sector) {
		$this->sector->set('id_sector', $sector);
		$data = $this->sector->get_sector();
		return $data;
	}

	public function listSectors() {
		$data = $this->sector->get_sectors();
		return $data;
	}
}
