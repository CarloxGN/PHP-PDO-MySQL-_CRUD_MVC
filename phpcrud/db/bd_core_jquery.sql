...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-12-2018 a las 07:15:30
...
--
-- Estructura de tabla para la tabla `tbl_cities`
--
...
CREATE TABLE `tbl_cities` (
  ...
  `capital_city` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `tbl_cities`
--

INSERT INTO `tbl_cities` (`id_city`, `id_state`, `name_city`, `capital_city`) VALUES
(1, 1, 'Maroa', 0),
...
--
-- Estructura de tabla para la tabla `tbl_counties`
--

CREATE TABLE `tbl_counties` (
  `id_county` int(11) NOT NULL,
  `id_state` int(11) NOT NULL,
  `name_county` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `tbl_counties`
--

INSERT INTO `tbl_counties` (`id_county`, `id_state`, `name_county`) VALUES
(1, 1, 'Alto Orinoco'),
(2, 1, 'Atabapo'),
(3, 1, 'Atures'),
(4, 1, 'Autana'),
...
--
-- Estructura de tabla para la tabla `tbl_sectors`
--
...
--
-- Volcado de datos para la tabla `tbl_sectors`
--

INSERT INTO `tbl_sectors` (`id_sector`, `id_county`, `name_sector`) VALUES
(1, 1, 'Alto Orinoco'),
...
INSERT INTO `tbl_states` (`id_state`, `id_country`, `name_state`, `iso_3166-2`) VALUES
(1, 232, 'Amazonas', 'VE-X'),
(2, 232, 'Anzo&aacute;tegui', 'VE-B'),
(3, 232, 'Apure', 'VE-C'),
(4, 232, 'Aragua', 'VE-D'),
(5, 232, 'Barinas', 'VE-E'),
(6, 232, 'Bol&iacute;var', 'VE-F'),
(7, 232, 'Carabobo', 'VE-G'),
(8, 232, 'Cojedes', 'VE-H'),
(9, 232, 'Delta Amacuro', 'VE-Y'),
(10, 232, 'Falc&oacute;n', 'VE-I'),
(11, 232, 'Gu&aacute;rico', 'VE-J'),
(12, 232, 'Lara', 'VE-K'),
(13, 232, 'M&eacute;rida', 'VE-L'),
(14, 232, 'Miranda', 'VE-M'),
(15, 232, 'Monagas', 'VE-N'),
(16, 232, 'Nueva Esparta', 'VE-O'),
(17, 232, 'Portuguesa', 'VE-P'),
(18, 232, 'Sucre', 'VE-R'),
(19, 232, 'T&aacute;chira', 'VE-S'),
(20, 232, 'Trujillo', 'VE-T'),
(21, 232, 'Vargas', 'VE-W'),
(22, 232, 'Yaracuy', 'VE-U'),
(23, 232, 'Zulia', 'VE-V'),
(24, 232, 'Distrito Capital', 'VE-A'),
(25, 232, 'Dependencias Federales', 'VE-Z');
...
(9, 'Josefina', 'DÃ­az', 1234567890, 'josefinadiaz@correopersonal.com', 665242345, 75, '&#34;userId&#34;: 1,\r\n    &#34;id&#34;: 1,\r\n    &#34;title&#34;: &#34;sunt aut facere repellat provident occaecati excepturi optio reprehenderit&#34;,\r\n    &#34;body&#34;: &#34;quia et suscipit\\nsuscipit recusandae consequuntur expedita et cum\\nreprehenderit molestiae ut ut quas totam\\nnostrum rerum est autem sunt rem eveniet architecto&#34;');
...
--
-- Indices de la tabla `tbl_cities`
--
...
--
-- Indices de la tabla `tbl_counties`
--
...
--
-- Indices de la tabla `tbl_sectors`
--
...
--
-- Indices de la tabla `tbl_states`
--
ALTER TABLE `tbl_states`
  ADD PRIMARY KEY (`id_state`),
  ADD KEY `states_ibfk_1` (`id_country`);
...
--
-- AUTO_INCREMENT de la tabla `tbl_cities`
--
ALTER TABLE `tbl_cities`
  MODIFY `id_city` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=523;

--
-- AUTO_INCREMENT de la tabla `tbl_counties`
--
ALTER TABLE `tbl_counties`
  MODIFY `id_county` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=463;
...
--
-- AUTO_INCREMENT de la tabla `tbl_sectors`
--
ALTER TABLE `tbl_sectors`
  MODIFY `id_sector` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1139;

--
-- AUTO_INCREMENT de la tabla `tbl_states`
--
ALTER TABLE `tbl_states`
  MODIFY `id_state` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
-- Filtros para la tabla `tbl_cities`
--
ALTER TABLE `tbl_cities`
  ADD CONSTRAINT `cities_ibfk_1` FOREIGN KEY (`id_state`) REFERENCES `tbl_states` (`id_state`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_counties`
--
ALTER TABLE `tbl_counties`
  ADD CONSTRAINT `counties_ibfk_1` FOREIGN KEY (`id_state`) REFERENCES `tbl_states` (`id_state`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_states`
--
ALTER TABLE `tbl_states`
  ADD CONSTRAINT `states_ibfk_1` FOREIGN KEY (`id_country`) REFERENCES `tbl_countries` (`id_country`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
